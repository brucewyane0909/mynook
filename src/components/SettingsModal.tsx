  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-lg bg-[#F9F7F2] dark:bg-[#21211E] rounded-sm shadow-2xl border border-[#E5E1D8] dark:border-[#2E2E2A] overflow-hidden"
      >
        {/* Header */}
        ...
        <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
          ...
          <div>
            ...
            <form onSubmit={handleSaveAuthor} className="flex gap-2">
              <input
                ...
                className="flex-1 px-3.5 py-2 text-sm rounded-sm bg-white dark:bg-[#181816] text-[#1A1A1A] dark:text-[#ECE9E2] border border-[#E5E1D8] dark:border-[#2E2E2A] focus:outline-none focus:border-[#3A3A36] dark:focus:border-[#ECE9E2]"
              />
              <button
                type="submit"
                className="px-4 py-2 rounded-sm text-[10px] font-bold uppercase tracking-widest bg-[#3A3A36] hover:bg-black dark:bg-[#ECE9E2] dark:hover:bg-white text-white dark:text-[#1A1A1A] transition-colors"
              >
          ...
          {/* Theme Switch */}
          <div className="flex items-center justify-between pt-4 border-t border-[#E5E1D8] dark:border-[#2E2E2A]">
            <div>
            ...
            <button
              ...
              className="px-3.5 py-1.5 rounded-sm text-[10px] font-bold uppercase tracking-widest bg-[#EBE8E0] dark:bg-[#282824] text-[#3A3A36] dark:text-[#ECE9E2] border border-[#E5E1D8] dark:border-[#2E2E2A] hover:bg-[#3A3A36] hover:text-white dark:hover:bg-[#ECE9E2] dark:hover:text-[#1A1A1A] transition-colors"
            >
            ...
            <div className="space-y-2 text-xs">
              <div className="flex items-center justify-between p-2.5 rounded-sm bg-white dark:bg-[#181816] border border-[#E5E1D8] dark:border-[#2E2E2A]">
                <div className="flex items-center gap-2 text-[#3A3A36] dark:text-[#ECE9E2]">
                  <Database className="w-4 h-4 text-[#8A8882]" />
              ...
              <div className="flex items-center justify-between p-2.5 rounded-sm bg-white dark:bg-[#181816] border border-[#E5E1D8] dark:border-[#2E2E2A]">
                <div className="flex items-center gap-2 text-[#3A3A36] dark:text-[#ECE9E2]">
                  <Wifi className="w-4 h-4 text-[#8A8882]" />
              ...
              <div className="flex items-center justify-between p-2.5 rounded-sm bg-white dark:bg-[#181816] border border-[#E5E1D8] dark:border-[#2E2E2A]">
                <div className="flex items-center gap-2 text-[#3A3A36] dark:text-[#ECE9E2]">
                  <Cloud className="w-4 h-4 text-[#8A8882]" />
          ...
          <div className="pt-4 border-t border-[#E5E1D8] dark:border-[#2E2E2A] space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-[11px] text-[#5A5852] dark:text-[#A8A59E]">
        ...
        {/* Footer */}
        <div className="px-6 py-3.5 bg-[#EBE8E0] dark:bg-[#181816] border-t border-[#E5E1D8] dark:border-[#2E2E2A] text-center text-[10px] uppercase font-bold tracking-widest text-[#8A8882]">
